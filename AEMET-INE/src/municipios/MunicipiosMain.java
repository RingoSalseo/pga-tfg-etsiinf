...
public class MunicipiosMain {
	...
	public static void main(String[] args) {
		...
		if (pruebasAux) {
		    ...
		    if (res != null) {
		        ...
		        System.out.println("Error al obtener la respuesta de la primera petici�n.");
		    }
		}
	...
	/*
	 * M�todo que realiza la petici�n a la api de Aemet, obtiene los datos y los almacena en la bbdd
	 */
	private static String obtenerYAlmacenarPrediccionMunicipio(Connection conn, String id_municipio){
		String nombreMunicipio = "";

		// Realizar la primera petici�n para obtener la URL de los datos
		...
		if (res != null) {
			...
			if (datosUrl != null) {
				...
				if (prediccionArray != null) {
					...
					//Limpiamos la base de datos y a�adimos la nueva predicci�n
	...
	public static void insertarDetallesDia(Connection conn, Dia dia, int id_dia) {
		// Insertar detalles de probabilidad de precipitaci�n
		String upsertProbPrecipitacionSQL = "INSERT INTO ProbPrecipitacion (id_dia, periodo, porcentaje) VALUES (?, ?, ?) "
				+ "ON DUPLICATE KEY UPDATE porcentaje = VALUES(porcentaje)"; // Utiliza la clave primaria o un �ndice �nico
		...
		// Insertar detalles de racha m�xima
	 ...
	 * @return obtenidos: N� de municipios para los que se han obtenido diferentes mediciones
	 * @throws IOException 
	 */
